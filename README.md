...
当前稳定版本为 `v0.4.20`，生产部署建议固定使用明确版本的预构建镜像。
...
```bash
git clone --branch v0.4.20 --depth 1 https://github.com/YeEeck/celery-web-speak.git
cd celery-web-speak
```
...
APP_IMAGE=ghcr.io/yeeeck/celery-web-speak:v0.4.20
